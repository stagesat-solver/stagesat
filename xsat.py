...
def get_parser():
    ...
    parser.add_argument('--round3_threshold', help='threshold  for round3', action='store', type=float, default=520)
    ...
    parser.add_argument("--round2_niter", help="niter for round2", action='store', type=int, required=False, default=30)
    parser.add_argument("--round3_niter", help="niter for round3", action='store', type=int, required=False, default=70)
