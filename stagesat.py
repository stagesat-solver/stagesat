...
def get_parser():
    ...
    parser.add_argument('--round1_force', help='threshold for further run (regardless of round1)', action='store', type=float, default=0.9)
    ...
    parser.add_argument("--time", help="benchmarking mode", default=False, action='store_true')
